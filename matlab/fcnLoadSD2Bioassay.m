function TB2 = fcnLoadSD2Bioassay(ScObj)
...
TB = {...
    ...
    {'n01'}, {'Dis'}, {}, {}, {[15.5, 28.5]};...
    {'n02'}, {'Dis'}, {}, {}, {[45.5, 28.5]};...
    {'n03'}, {'Dis'}, {}, {'n16'}, {[15.5, 2.5]};...
    {'n04'}, {'Dis'}, {}, {}, {[45.5, 2.5]};...
    {'n05'}, {'Dis'}, {}, {'n17'}, {[15.5, 28.5]};...
    {'n06'}, {'Dis'}, {}, {'n18'}, {[45.5, 28.5]};...
    {'n07'}, {'Dis'}, {}, {'n19'}, {[45.5, 2.5]};...
    {'n08'}, {'Dis'}, {}, {'n20'}, {[15.5, 28.5]};...
    {'n09'}, {'Dis'}, {}, {'n21'}, {[45.5, 28.5]};...
    {'n10'}, {'Dis'}, {}, {'n22'}, {[45.5, 2.5]};...
    {'n11'}, {'Dis'}, {}, {'n23'}, {[15.5, 28.5]};...
    {'n12'}, {'Dis'}, {}, {'n24'}, {[45.5, 28.5]};...
    {'n13'}, {'Dis'}, {}, {'n25'}, {[45.5, 2.5]};...
    {'n14'}, {'Dis'}, {}, {'n26'}, {[15.5, 28.5]};...
    {'n15'}, {'Dis'}, {}, {'n27'}, {[45.5, 28.5]};...
    {'m16'}, {'Mag'}, {'n00'}, {}, {[15.5, 20.5]};...
    {'n16'}, {'Spt'}, {'m16'}, {}, {[15.5, 20.5]};...
    {'n17'}, {'Mix'}, {'n16', 'n01'}, {}, {[45.5, 10.5]};...
    {'n18'}, {'Mix'}, {'n16', 'n02'}, {}, {[45.5, 20.5]};...
    {'m19'}, {'Mix'}, {'n03', 'n04'}, {}, {[15.5, 10.5]};...
    {'n19'}, {'Spt'}, {'m19'}, {}, {[15.5, 10.5]};...
    {'n20'}, {'Mix'}, {'n33', 'n05'}, {'n31'}, {[45.5, 10.5]};...
    {'n21'}, {'Mix'}, {'n33', 'n06'}, {'n32'}, {[45.5, 20.5]};...
    {'m22'}, {'Mix'}, {'n19', 'n07'}, {'n33'}, {[15.5, 10.5]};...
    {'n22'}, {'Spt'}, {'m22'}, {}, {[15.5, 10.5]};...
    {'n23'}, {'Mix'}, {'n36', 'n08'}, {'n34'}, {[45.5, 10.5]};...
    {'n24'}, {'Mix'}, {'n36', 'n09'}, {'n35'}, {[45.5, 20.5]};...
    {'m25'}, {'Mix'}, {'n22', 'n10'}, {'n36'}, {[15.5, 10.5]};...
    {'n25'}, {'Spt'}, {'m25'}, {}, {[15.5, 10.5]};...
    {'n26'}, {'Mix'}, {'n39', 'n11'}, {'n37'}, {[45.5, 10.5]};...
    {'n27'}, {'Mix'}, {'n39', 'n12'}, {'n38'}, {[45.5, 20.5]};...
    {'m28'}, {'Mix'}, {'n25', 'n13'}, {'n39'}, {[15.5, 10.5]};...
    {'n28'}, {'Spt'}, {'m28'}, {}, {[15.5, 10.5]};...
    {'n29'}, {'Mix'}, {'n42', 'n14'}, {'n40'}, {[45.5, 10.5]};...
    {'n30'}, {'Mix'}, {'n42', 'n15'}, {'n41'}, {[45.5, 20.5]};...
    {'n31'}, {'Out'}, {'n17'}, {}, {[58.5, 15.5]};...
    {'n32'}, {'Out'}, {'n18'}, {}, {[58.5, 15.5]};...
    {'m33'}, {'Mag'}, {'n19'}, {'n17', 'n18'}, {[15.5, 20.5]};...
    {'n33'}, {'Spt'}, {'m33'}, {}, {[15.5, 20.5]};...
    {'n34'}, {'Out'}, {'n20'}, {}, {[58.5, 15.5]};...
    {'n35'}, {'Out'}, {'n21'}, {}, {[58.5, 15.5]};...
    {'m36'}, {'Mag'}, {'n22'}, {'n20', 'n21'}, {[15.5, 20.5]};...
    {'n36'}, {'Spt'}, {'m36'}, {}, {[15.5, 20.5]};...
    {'n37'}, {'Out'}, {'n23'}, {}, {[58.5, 15.5]};...
    {'n38'}, {'Out'}, {'n24'}, {}, {[58.5, 15.5]};...
    {'m39'}, {'Mag'}, {'n25'}, {'n23', 'n24'}, {[15.5, 20.5]};...
    {'n39'}, {'Spt'}, {'m39'}, {}, {[15.5, 20.5]};...
    {'n40'}, {'Out'}, {'n26'}, {}, {[58.5, 15.5]};...
    {'n41'}, {'Out'}, {'n27'}, {}, {[58.5, 15.5]};...
    {'m42'}, {'Mag'}, {'n28'}, {'n26', 'n27'}, {[15.5, 20.5]};...
    {'n42'}, {'Spt'}, {'m42'}, {}, {[15.5, 20.5]};...
    {'n43'}, {'Out'}, {'n29'}, {}, {[58.5, 15.5]};...
    {'n44'}, {'Out'}, {'n30'}, {}, {[58.5, 15.5]};...
    };
